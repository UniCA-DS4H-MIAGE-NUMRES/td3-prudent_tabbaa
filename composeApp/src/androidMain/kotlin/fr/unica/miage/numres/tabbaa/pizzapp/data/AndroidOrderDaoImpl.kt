...
import fr.unica.miage.numres.tabbaa.pizzapp.model.toEntity
import fr.unica.miage.numres.tabbaa.pizzapp.model.toOrder
import kotlinx.coroutines.flow.Flow
import kotlinx.coroutines.flow.first
import kotlinx.coroutines.flow.map

class AndroidOrderDaoImpl(private val androidDao: AndroidOrderDao) : OrderDao {
    override suspend fun insertOrder(order: fr.unica.miage.numres.tabbaa.pizzapp.model.Order) {
        androidDao.insertOrder(order.toEntity())
    }

    override fun getAllOrders(): Flow<List<fr.unica.miage.numres.tabbaa.pizzapp.model.Order>> {
